...
# ./bin/opt/test.exe: ./include/header1.hpp ./include/header2.hpp $(OPT_OBJ) ./obj/opt/test.obj
# 	CL $(OPT_OBJ) ./obj/opt/test.obj $(OPT) $(WARNING) $(DEFINES) /Fe./bin/opt/test.exe

# ./bin/debug/test.exe: ./include/header1.hpp ./include/header2.hpp $(DEV_OBJ) ./obj/debug/test.obj
# 	CL $(DEV_OBJ) ./obj/debug/test.obj $(DEV) $(WARNING) $(DEFINES) /Fe./bin/debug/test.exe

# ./bin/opt/select.exe: ./include/header1.hpp ./include/header2.hpp $(OPT_OBJ) ./obj/opt/select.obj
# 	CL $(OPT_OBJ) ./obj/opt/select.obj $(OPT) $(WARNING) $(DEFINES) /Fe./bin/opt/select.exe

# ./bin/debug/select.exe: ./include/header1.hpp ./include/header2.hpp $(DEV_OBJ) ./obj/debug/select.obj
# 	CL $(DEV_OBJ) ./obj/debug/select.obj $(DEV) $(WARNING) $(DEFINES) /Fe./bin/debug/select.exe

# ./bin/opt/join.exe: ./include/header1.hpp ./include/header2.hpp $(OPT_OBJ) ./obj/opt/join.obj
# 	CL $(OPT_OBJ) ./obj/opt/join.obj $(OPT) $(WARNING) $(DEFINES) /Fe./bin/opt/join.exe

# ./bin/debug/join.exe: ./include/header1.hpp ./include/header2.hpp $(DEV_OBJ) ./obj/debug/join.obj
# 	CL $(DEV_OBJ) ./obj/debug/join.obj $(DEV) $(WARNING) $(DEFINES) /Fe./bin/debug/join.exe
